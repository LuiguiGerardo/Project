...
role="dialog" tabindex="-1" id="modal-restaurar-{{ $proveedor->id }}">
	<form action="/proveedor-restaurar/{{ $proveedor->id }}" method="GET">	
		{{ csrf_field() }}	
		<div class="modal-dialog">
			<div class="modal-content modal-col-indigo">
				...
				<div class="modal-body">
                    <h3><b>¿Seguro que desea restaurar este proveedor?</b></h3>  
				</div>
